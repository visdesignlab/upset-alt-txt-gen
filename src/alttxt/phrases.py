DESCRIPTIONS = {
    ...
    'level_1': {
        'low':
            'This an UpSet plot that plots the {{title}}. A total of {{total}} '
            'co-occuring variables are displayed. They read from left to right '
            'as: {{list_set_names}}.',

        'medium':
            'This an UpSet plot of {{caption}} that plots the {{title}}. A total '
            'of {{total}} co-occuring variables are displayed. They read from left '
    ...
    'level_2': {
        'low':
            'This is an upset plot. Set memberships comprised of {{list_max_set_names}} '
            ...
            'have the lowest frequency, amounting barely {{min_perc}} of all memberships.',

        'medium':
            'In {{title}}, set memberships comprised of {{list_max_set_names}} '
            'have the highest re-occurrence totaling {{max_percentage}} of these. '
            'In contrast, set membership consisting of {{list_min_set_names}} have '
            'the lowest frequency, amounting only {{min_percentage}} of all.',
