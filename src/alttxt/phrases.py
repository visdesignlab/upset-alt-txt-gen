DESCRIPTIONS = {
    ...
    "level_2": {
        ...
        "have the lowest frequency count, amounting barely {{min_perc}} of all "
        "memberships.",
        "medium": "In {{title}}, set memberships comprised of {{list_max_set_names}} "
        ...
        "high": "In {{title}}, set memberships comprised of {{list_max_set_names}} "
        "have the highest re-occurrence totaling {{max_percentage}} of these. "
        "In contrast, set membership consisting of {{list_min_set_names}} have "
        "the lowest frequency, amounting only {{min_percentage}} of all.",
    },
